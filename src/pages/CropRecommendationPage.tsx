...
export const CropRecommendationPage: React.FC = () => {
  ...
  const [historyPrev1, setHistoryPrev1] = useState<string>("Paddy (Rice)");
  const [historyPrev2, setHistoryPrev2] = useState<string>("Wheat");
  const [historyYear, setHistoryYear] = useState<string>("2025");
  const [historyYield, setHistoryYield] = useState<string>("22 Qtl/Acre");
  ...
  const handleAddHistory = () => {
    ...
    const newRecord: CropHistoryRecord = {
      id: "h_" + Date.now(),
          ...
          {!isAnalyzing && showAnalysis && aiReport && (
            <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="relative w-24 h-24 flex items-center justify-center">
                      <svg className="w-full h-full transform -rotate-90">
                        ...
                        <circle
                          ...
                          strokeDashoffset={188.4 - (aiReport.healthScore / 100) * 188.4}
                          strokeLinecap="round"
                        />
                      </svg>
                      <div className="absolute text-base font-black text-white">{aiReport.healthScore} / 100</div>
                    </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  {aiReport.recommendations.map((crop: any, index: number) => (
