...
export const IrrigationPage = () => {
  ...
  const matchedCrop = cropsData.find((c) => c.id.toLowerCase() === cropId.toLowerCase()) || 
                      cropsData.find((c) => c.name.en.toLowerCase().includes(cropId.toLowerCase()));
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 relative text-left">
      ...
      {weatherError && (
        <div className="max-w-2xl mx-auto mb-8">
          <div className="border border-rose-500/20 bg-rose-500/10 p-6 rounded-2xl text-center space-y-4">
